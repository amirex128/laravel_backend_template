<?php //c48e1d46ebdd4fda9fd04eefc0288c00
/** @noinspection all */
...
namespace Laravel\Octane\Facades {
    ...
    /**
     * @see \Laravel\Octane\Concerns\ProvidesDefaultConfigurationOptions::prepareApplicationForNextRequest
     * @method static string[] prepareApplicationForNextRequest()
     * @see \Laravel\Octane\Concerns\ProvidesRouting::route
     * @method static void route(string $method, string $uri, \Closure $callback)
     * @see \Laravel\Octane\Octane::formatExceptionForClient
     * @method static string formatExceptionForClient(\Throwable $e, bool $debug = false)
     * @see \Laravel\Octane\Concerns\ProvidesRouting::hasRouteFor
     * @method static bool hasRouteFor(string $method, string $uri)
     * @see \Laravel\Octane\Concerns\ProvidesConcurrencySupport::concurrently
     * @method static array concurrently(array $tasks, int $waitMilliseconds = 3000)
     * @see \Laravel\Octane\Concerns\ProvidesRouting::invokeRoute
     ...
     * @see \Laravel\Octane\Concerns\ProvidesDefaultConfigurationOptions::prepareApplicationForNextOperation
     * @method static string[] prepareApplicationForNextOperation()
     * @see \Laravel\Octane\Concerns\ProvidesDefaultConfigurationOptions::defaultServicesToWarm
     * @method static string[] defaultServicesToWarm()
     * @see \Laravel\Octane\Concerns\RegistersTickHandlers::tick
     ...
     * @see \Laravel\Octane\Octane::table
     * @method static \Swoole\Table table(string $table)
     * @see \Laravel\Octane\Concerns\ProvidesConcurrencySupport::tasks
     * @method static \Laravel\Octane\Contracts\DispatchesTasks|\Laravel\Octane\SequentialTaskDispatcher|\Laravel\Octane\Swoole\SwooleHttpTaskDispatcher|\Laravel\Octane\Swoole\SwooleTaskDispatcher tasks()
     */
    class Octane {}
}
